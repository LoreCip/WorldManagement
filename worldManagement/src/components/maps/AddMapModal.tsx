...
export const AddMapModal: React.FC<AddMapModalProps> = ({ isOpen, existingMaps, initialFilePath, onClose, onMapAdded }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} width="450px" title={t("maps.form.newMap")} closeDisabled={isLoading}>
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", gap: "0.8rem", marginTop: "1rem" }}>
                    <button type="button" onClick={onClose} disabled={isLoading} style={{ padding: "0.55rem 1.2rem", borderRadius: radii.md, backgroundColor: "transparent", color: colors.textSecondary, border: `1px solid ${colors.border}`, cursor: "pointer" }}>
                        {t("common.cancel")}
                    </button>
                    <button
                        type="submit"
