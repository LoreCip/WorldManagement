...
export const TimelineEventBalloon: React.FC<TimelineEventBalloonProps> = ({
  ...
  const updateTime = (
    patch: Partial<{ year: number; month: number | null; day: number | null }>,
  ) => {
    ...
    >
      ...
      <div style={{ marginBottom: "0.7rem" }}>
        {isEditing ? (
          ...
          <div style={{ color: colors.textSecondary, fontSize: "0.78rem" }}>
            {t("timeline.balloon.until", {
              date: formatDisplayTime({ ...event, time_value: event.end_time_value! }, t),
            })}
          </div>
        ) : null}
          ...
          >
            ...
            <span
              style={{
                ...
                height: "9px",
                borderRadius: "50%",
                backgroundColor: linkedCategory.color,
              }}
            />
            {linkedCategory.name}
          </span>
      ...
      <div style={{ marginBottom: "0.7rem" }}>
        ...
        {isEditing ? (
          ...
          >
            {event.description || (
              <span style={{ color: colors.textFaint, fontStyle: "italic" }}>
                {t("timeline.balloon.noDescr")}
              </span>
            )}
          </div>
        )}
      ...
      {/* Collegamenti */}
      <div
        style={{ marginBottom: "0.9rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}
      >
        <div>
...
function formatDisplayTime(
  ...
  if (event.precision === "month")
    return t("timeline.balloon.monthDisplay", { month: month ?? 1, year });
