...
const PortalBadge: React.FC<{
  node: GraphNodeData;
  onNavigateToView?: (viewId: string) => void;
}> = ({ node, onNavigateToView }) => {
    ...
    return (
      ...
      >
        ...
        <div style={{ fontSize: "0.85rem" }}>
          {node.displayName || t("relations.nodeTypes.unknown")}
        </div>
      </div>
    );
  }
    ...
    >
      ...
      <div style={{ borderRadius: radii.lg, overflow: "hidden" }}>
        ...
        >
          <span>
            {node.type === "entity"
              ? t("relations.nodeTypes.entity")
              : t("relations.nodeTypes.character")}
          </span>
